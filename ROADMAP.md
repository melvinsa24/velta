...
- **Phase active** : Phase 5 — Catégories & paramètres (Phase 4 Charte graphique terminée)
- **Prochaine étape concrète** : Écran Réglages (squelette déjà en place) → CRUD catégories (couleur, mode de partage, flag crédit) et réglage de l'objectif % avec auto-complétion du 3e champ.
